...
that returns a transducers. Let's revisit our definition of `process-cluster` and define it in terms of
transducers:
...
// TODO: implement cat & mapcat because otherwise this will not be well understood
