...
values that can have metadata
- symbols
- vars
- persistent collections and their derivates (subvec for example)
- defn'd functions (vars)
- atom

syntax support for metadata
...
metadata usages
- var definition line, column and ns
- testing, :test metadata for discovery
