...
compatibility issues, so we’d like one step up from plain ClojureScript.  The solution is xref:google-closure[the Google Closure library].

anchor:google-closure[]
=== The Closure Library
