...
The `done` function exposed by the `async` macro should be called after asynchronous
...
Most of continuous integration tools and services expect that test scripts you provide
