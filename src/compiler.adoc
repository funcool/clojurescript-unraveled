...
==== CommonJS or AMD modules compatible libraries
...
The way for include this kind of modules is pretty easy because it is almos identical
to previous methods with little differences:
