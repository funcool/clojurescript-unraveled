...
Maps are a collection abstraction that allows you to store ordered key/value pairs. In other
languages this type of structure is commonly known as a hash-map or dict. Map literals in _ClojureScript_ are
