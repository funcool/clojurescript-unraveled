...
the REPL wants to fully evaulate the expression.
...
vars. 
Any ClojureScript data structure can be used as a key in a map, although it's common to use keywords since they can
also be called as functions.

////
Joe the Beginning Programmer asks: "What do you mean by 'attaching metadata to vars'? I'm confused."
Really, you need a reference to the section where you discuss metadata, or you need to get rid of it in the preceding text.
////
