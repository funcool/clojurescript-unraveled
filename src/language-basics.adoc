...
Jointly with the ability to implement the callable protocol (the `IFn`), data
structures like sets can be used just as predicates, without need of additional
