...
Maps are collections of key-and-value pairs. In addition to their normal use, they are also used as a syntactic construct for attaching xref:metadata-section[metadata] to vars.  Like vectors, maps are ubiquitous in ClojureScript.
